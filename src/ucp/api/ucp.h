 ...
 * A callack must have either the SYNC or ASYNC flag set.
 */
enum ucp_cb_flags {
 ...
 *
 * This routine adds a user defined callback to be used for ucp_ep_am_put.
 *
...
ucs_status_t ucp_ep_set_am_handler(ucp_ep_h ep, uint8_t id, 
